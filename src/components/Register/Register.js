    ...
    return (
        <section className="signup">
            ...
            <form className="signup__form">
                ...
                <input id="name" className="signup__input" type="text" />
                <label htmlFor="email" className="signup__label">E-mail</label>
                <input id="email" className="signup__input" type="email" />
                <label htmlFor="password" className="signup__label">Пароль</label>
                <input id="password" className="signup__input" type="password" />
